...
class Building {
     ...
     */
    initializeFromType() {
        const buildingData = this.game.buildingData.getBuildingData(this.type);
...
if (typeof module !== 'undefined' && module.exports) {
    module.exports = { Building, ProductionBuilding, ResidentialBuilding, ResearchBuilding };
} else {
    window.Building = Building;
    window.ProductionBuilding = ProductionBuilding;
    window.ResidentialBuilding = ResidentialBuilding;
    window.ResearchBuilding = ResearchBuilding;
}